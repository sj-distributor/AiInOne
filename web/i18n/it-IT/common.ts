const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account AiInOne',
    langGeniusAccountTip: 'Il tuo account AiInOne e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a AiInOne per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da AiInOne ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di AiInOne.',
  ...
  about: {
    ...
    nowAvailable: 'AiInOne {{version}} è ora disponibile.',
    latestAvailable: 'AiInOne {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
