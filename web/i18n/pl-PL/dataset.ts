const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją AiInOne ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza AiInOne i pobierania wiedzy z tej bazy wiedzy.',
}
