const translation = {
  ...
  welcome: 'به AiInOne خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع AiInOne Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در AiInOne',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش AiInOne',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در AiInOne استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
}
