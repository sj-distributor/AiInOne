const translation = {
  ...
  welcome: '👋 Welcome to AiInOne, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting AiInOne Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on AiInOne',
  invalid: 'The link has expired',
  explore: 'Explore AiInOne',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on AiInOne and we will send you a password reset email.',
