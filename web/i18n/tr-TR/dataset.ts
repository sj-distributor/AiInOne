const translation = {
  ...
  intro1: 'Bilgi, AiInOne uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, AiInOne dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
