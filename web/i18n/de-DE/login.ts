const translation = {
  ...
  welcome: 'Willkommen bei AiInOne, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit AiInOne Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf AiInOne beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'AiInOne erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei AiInOne angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
