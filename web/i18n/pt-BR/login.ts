const translation = {
  ...
  welcome: 'Bem-vindo ao AiInOne, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do AiInOne, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no AiInOne',
  invalid: 'O link expirou',
  explore: 'Explorar o AiInOne',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no AiInOne e enviaremos um e-mail de redefinição de senha.',
