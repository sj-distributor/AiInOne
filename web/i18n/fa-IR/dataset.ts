const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه AiInOne ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از AiInOne و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
