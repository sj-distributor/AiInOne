const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AiInOne-Konto',
    langGeniusAccountTip: 'Ihr AiInOne-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei AiInOne anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von AiInOne ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in AiInOnes Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'AiInOne {{version}} ist jetzt verfügbar.',
    latestAvailable: 'AiInOne {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
