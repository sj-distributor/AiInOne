const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AiInOne hesabı',
    langGeniusAccountTip: 'AiInOne hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, AiInOne\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'AiInOne tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  apiBasedExtension: {
    title: 'API uzantıları merkezi API yönetimi sağlar, AiInOne\'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.',
  ...
  about: {
    ...
    nowAvailable: 'AiInOne {{version}} şimdi mevcut.',
    latestAvailable: 'AiInOne {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
