const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte aiinone',
    langGeniusAccountTip: 'Votre compte aiinone et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à aiinone pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par aiinone vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de aiinone.',
    link: 'Apprenez comment développer votre propre Extension API.',
    linkUrl: 'https://docs.aiinone.ai/fonctionnalites/extension/extension_basee_sur_api',
  ...
  about: {
    ...
    nowAvailable: 'aiinone {{version}} est maintenant disponible.',
    latestAvailable: 'aiinone {{version}} est la dernière version disponible.',
  },
  appMenus: {
