const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a AiInOne cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a AiInOne.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome AiInOne Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
