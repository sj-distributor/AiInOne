const translation = {
  ...
  welcome: 'AiInOne\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'AiInOne Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'AiInOne\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
